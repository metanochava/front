...
// The consultation PDF uses the SAME bands and calculations on the server
// (dev/back saude/services/vital_signs_service.py RULES / calculations):
// change both together - saude/tests/test_consultation_pdf.py pins the cases.
...
// display units (the same as the backend limits, vital_signs_service.LIMITS)
export const UNITS = {
